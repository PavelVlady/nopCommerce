...
namespace Nop.Plugin.Payments.PayPalStandard
{
    ...
    public class PayPalStandardPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public override void Install()
        {
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayPalStandard.PaymentMethodDescription", "You will be redirected to PayPal site to complete the order");
        ...
        {
            //you need to return a localized string resource to allow to display this payment method description on checkout pages
            //for example for the redirection payment method, the description may be like this: "You will be redirected to PayPal site to complete the order"
